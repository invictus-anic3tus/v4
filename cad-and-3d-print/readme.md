...
You can find the 3D print files in the 3D Print directory in .stl format. The file name will have instructions as to what filament and basic settings to use, as does the readme in that folder.
